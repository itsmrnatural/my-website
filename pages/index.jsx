  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="mt-11 md:mt-14 backdrop-blur-sm rounded-lg p-5 border border-white/10"
      >
      ...
      <motion.div
        ...
        className="mt-11 md:mt-14 pb-5 border-b border-white/10"
      >
          ...
          {["Python", "JavaScript", "React", "Tailwind CSS", "C++", "Rust", "Elixir"].map(
            (tech) => (
              <motion.span
                ...
                className="px-3 py-1.5 bg-white/5 border border-white/10 hover:border-fuchsia-500/30 hover:bg-white/10 transition-all duration-300 rounded-md text-xs font-medium"
              >
                {tech}
              </motion.span>
            )
      ...
      >
        ...
        <div className="space-y-6">
          <div className="group border-l-2 border-fuchsia-500/30 pl-3.5 hover:border-fuchsia-500/70 transition-all">
            <div className="flex items-center">
              ...
              <h3 className="font-medium text-sm">Learning & Studying</h3>
            </div>
          ...
          <div className="group border-l-2 border-violet-500/30 pl-3.5 hover:border-violet-500/70 transition-all">
            <div className="flex items-center">
              ...
              <h3 className="font-medium text-sm">Coffee Explorations</h3>
            </div>
            <p className="text-gray-400 mt-1.5 text-xs leading-relaxed">
          ...
          <div className="group border-l-2 border-fuchsia-500/30 pl-3.5 hover:border-fuchsia-500/70 transition-all">
            <div className="flex items-center">
              ...
              <h3 className="font-medium text-sm">Music Interests</h3>
            </div>
            <p className="text-gray-400 mt-1.5 text-xs leading-relaxed">
        ...
        <div className="mt-6 text-right">
          <Link href="/blog">
            <motion.a
              whileHover={{ scale: 1.05 }}
              className="inline-flex items-center text-xs text-fuchsia-400 hover:text-violet-300 transition-colors px-2.5 py-1 rounded-md bg-white/5 border border-white/10 hover:bg-white/10"
            >
