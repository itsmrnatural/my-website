          ...
          <div className="flex flex-col w-full sm:w-auto relative" ref={filterRef}>
            ...
            >
              ...
              <i
                ...
                } ml-2 text-coffee-700 dark:text-neutral-400 text-xs`}
              />
            </button>
                ...
                <div className="flex flex-wrap gap-2">
                  {availableLanguages.map((language) => (
                    <button
                      ...
                      className={`flex items-center px-2 py-0.5 rounded-md text-[11px] ${
              ...
              <div className="absolute top-full right-0 z-10 mt-2 p-1.5 rounded-lg bg-white dark:bg-neutral-800/90 border border-coffee-300 dark:border-neutral-700/50 w-52 overflow-hidden backdrop-blur shadow-lg">
                {sortOptions.map((option) => (
                  <button
                    ...
                    className={`flex items-center px-2.5 py-1.5 w-full text-left rounded-md text-xs md:text-sm ${
                      sortBy === option.value
                        ? "bg-coffee-300 dark:bg-neutral-700/80 text-coffee-900 dark:text-white"
                ...
                >
                  ...
                  <div className="relative flex flex-col h-full p-3.5">
                    ...
                    <div className="flex-grow mb-2.5">
                      <p className="text-xs md:text-sm text-coffee-700 dark:text-neutral-300 line-clamp-2 leading-relaxed">
            ...
            >
              ...
              <div className="flex items-start justify-between gap-2.5 mb-2">
                <div className="flex-1">
                  <div className="bg-coffee-200 dark:bg-neutral-800 h-4 w-3/4 rounded-md mb-1" />
                  <div className="bg-coffee-100 dark:bg-neutral-800/60 h-2.5 w-1/2 rounded-md" />
                </div>
                <div className="bg-coffee-200 dark:bg-neutral-800 h-6 w-16 rounded-lg" />
              </div>

              {/* Description skeleton */}
              <div className="flex-grow mb-2.5">
                <div className="bg-coffee-100 dark:bg-neutral-800/60 h-3.5 w-full rounded-md mb-1.5" />
                <div className="bg-coffee-100 dark:bg-neutral-800/60 h-3.5 w-4/5 rounded-md" />
              </div>

              {/* Footer skeleton */}
              <div className="flex items-center justify-between pt-2 border-t-2 border-coffee-200/40 dark:border-neutral-800/40">
                <div className="flex items-center gap-1.5">
                  <div className="bg-coffee-200 dark:bg-neutral-800 h-5 w-10 rounded-md" />
                  <div className="bg-coffee-200 dark:bg-neutral-800 h-5 w-10 rounded-md" />
                </div>
                <div className="bg-coffee-100 dark:bg-neutral-800/60 h-3 w-16 rounded-md" />
              </div>
            </div>
          ))
        )}
